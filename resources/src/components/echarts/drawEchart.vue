<template>
  <div>
    <div :id="echartObj.echartId" :style="{width:echartObj.width,height:echartObj.height}" ref="echarts"></div>
  </div>
</template>
    ...
    selfAdaption () {
      ...
      setTimeout(() => {
        window.addEventListener('resize', function () {
          _this.chart = _this.$echarts.init(document.getElementById(_this.echartObj.echartId))
          _this.chart.resize()
        })
      }, 10)
    }
